...
const TAB_DATA = [
  {
    ...
    id: "skills",
    content: (
      // <ul className="list-disc pl-2 flex justify-between items-center gap-2">
      //   <FaHtml5 color="#e34c26" fontSize="2.5em" />
      //   <FaReact color="#61dbfb" fontSize="2.5em" />
      //   <FaCss3Alt color="#2965f1" fontSize="2.5em" />
      //   <IoLogoJavascript color="#f0db4f" fontSize="2.5em" />
      //   <BsFiletypeSql color="#f29111" fontSize="2.5em" />
      //   <SiMysql color="#00758f" fontSize="2.5em" />
      //   <BiLogoPostgresql color="#00758f" fontSize="2.5em" />
      //   <label>C# .net</label>
      //   <label>C/C++</label>
      // </ul>
      <div className="flex justify-between items-center gap-2 md:text-[2.5em]">
        ...
        {/* <BiLogoPostgresql color="#00758f" fontSize="3.5em" /> */}
